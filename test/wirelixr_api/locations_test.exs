defmodule WirelixrApi.LocationsTest do
  use WirelixrApi.DataCase

  alias WirelixrApi.Locations

  describe "locations" do
    alias WirelixrApi.Locations.Location

    @valid_attrs %{centre: "some centre", country: "some country", id: "some id", name: "some name"}
    @update_attrs %{centre: "some updated centre", country: "some updated country", id: "some updated id", name: "some updated name"}
    @invalid_attrs %{centre: nil, country: nil, id: nil, name: nil}
    ...
    test "create_location/1 with valid data creates a location" do
      ...
      assert location.centre == "some centre"
      assert location.country == "some country"
      assert location.id == "some id"
    ...
    test "update_location/2 with valid data updates the location" do
      ...
      assert location.centre == "some updated centre"
      assert location.country == "some updated country"
      assert location.id == "some updated id"
