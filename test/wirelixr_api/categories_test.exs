defmodule WirelixrApi.CategoriesTest do
  use WirelixrApi.DataCase

  alias WirelixrApi.Categories

  describe "categories" do
    alias WirelixrApi.Categories.Category

    @valid_attrs %{name: "some name", visible: true}
    @update_attrs %{name: "some updated name", visible: false}
    @invalid_attrs %{name: nil, visible: nil}
